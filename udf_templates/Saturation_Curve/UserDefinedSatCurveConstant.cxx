...
double template_class_name::saturation_pressure(double T, unsigned iphase) {
   // any expression may be worked out to set saturation pressure within this function
   //
   ...
   //double Gamma    = 1.4;                                              //=
   // ====================================================================
   // here the saturation pressure is set to a constant value
   // the "Psat" variable is returned as the result


   
   // depending on models (Variable Psat must be activated)
   // and UDF set in the Phase Properties window for Saturation Curve
   double Psat = 3540;
   return Psat;
}
...
double template_class_name::saturation_temperature(double P, unsigned iphase) {
   ...
   // Likewise, Saturation Temperature may be set from any variables
   //   // depending on models (Variable Tsat must be activated)
   // and UDF set in the Phase Properties window for Saturation Curve
