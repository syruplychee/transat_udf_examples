...
void template_class_name::operator ()(int iphase, int icomponent) {
   ...
   for (int nb=0; nb < nblocks; nb++){
      ...
      for (int ii=0; ii < nijk; ii++) {
         ...
         // set MassFraction-source term for first component
         if (icomponent == 1) {
         
            rhs[ii] += 23;
         }
         // set MassFraction-source term for second component
         if (icomponent == 2) {
