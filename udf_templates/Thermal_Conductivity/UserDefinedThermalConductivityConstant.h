...
public:
   ...
   /**
    * @brief This is the function that is called for calculating Thermal Conductivity
    *        It is normally used as UDF. Here is a place holder and template
    *        the example uses Peng Robinson
    *
    *
    * @param mgr gives access to all the Properties Manager variables (Thermal Conductivity)
    * @param iphase is access to the phase 
    */
   virtual double Lambda(tmb::Properties_Manager*,unsigned);
private:
   /**
