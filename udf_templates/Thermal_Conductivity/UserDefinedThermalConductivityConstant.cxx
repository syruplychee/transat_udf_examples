...
double template_class_name::Lambda(tmb::Properties_Manager* mgr, unsigned iphase) {
   // any expression may be worked out to set Thermal Conductivity within this function
   //
   ...
   // here the Thermal Conductivity is set to a constant value
   // the "tc" variable is returned as the result
   double tc = 0.0257;
   return tc;
