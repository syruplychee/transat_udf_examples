/*
 * MasstransferCoeff_Functors.h
 *
 *  Created on: Sep 24, 2013
 *      Author: vonrickenbach
 */

#ifndef MasstransferCoeff_FUNCTORS_H_
#define MasstransferCoeff_FUNCTORS_H_
#include "MasstransferCoeff_Base.decl.h"
#include <vector>
#include <string>
#include <map>
 ...
 */
class MasstransferCoeff_constant : public MasstransferCoeff_Base {
public:
   MasstransferCoeff_constant();
   virtual ~MasstransferCoeff_constant();
...
class MasstransferCoeff_linear_fit : public MasstransferCoeff_Base {
public:
   MasstransferCoeff_linear_fit();
   virtual ~MasstransferCoeff_linear_fit();
...
#endif /* MasstransferCoeff_FUNCTORS_H_ */
